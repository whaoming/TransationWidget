...
/**
 * @author Squirrel
 *         created at 2017/3/3 21:10
 *         TODO:一个可以搭配多选adapter的多选recyclerview
 */
public class DragSelectRecyclerView extends RecyclerView {
    ...
    public void setAdapter(DragSelectRecyclerViewAdapter<?> adapter) {
        ...
        if (mAdapter instanceof MutiRecyclerViewAdapter) {
            mData = ((MutiRecyclerViewAdapter) mAdapter).getSource();
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        if (mDragSelectActive) {
            ...
            if (itemPosition < (mData == null ? 0 : mData.size())) {
