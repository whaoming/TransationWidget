...
public class PrintUtil {
    ...
    public void printMiddleText(String text) throws IOException {
    ...
    public static void printTest(BluetoothSocket bluetoothSocket, Bitmap bitmap) {
        ...
        try {
            ...
            pUtil.printLargeText("发货单\n");
            pUtil.printLine();
            pUtil.printAlignment(0);
            pUtil.printLine();

            pUtil.printText("收货人：简约至上\n");
            pUtil.printText("电话：13835824781\n");
            pUtil.printText("收货地址：广东省佛山市顺德区龙江镇什么什么街道某某大厦12楼1205\n");

            pUtil.printLine();
            pUtil.printMiddleText("货物清单\n");
            pUtil.printDashLine();
            pUtil.printText("藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅藤椅\n");
            pUtil.printLine();
            pUtil.printText("颜色：红色\n");
            pUtil.printText("尺寸：180*2000mm\n");
            pUtil.printTwoColumn("单价:$899", "x1");
            pUtil.printLine();
            pUtil.printLine();
            pUtil.printText("颜色：红色\n");
            pUtil.printText("尺寸：180*2000mm\n");
            ...
            pUtil.printTwoColumn("订单共1款3件", "$36666");
            pUtil.printTwoColumn("运费", "$300");
            pUtil.printTwoColumn("总计", "$300");
            pUtil.printDashLine();

            pUtil.printText("订单编号：546465456456456\n");
            pUtil.printText("创建时间：2017-09-07 73：23：10\n");
            pUtil.printLine();
            pUtil.printAlignment(1);
            pUtil.printMiddleText("哼哈匠APP\n");
            pUtil.printMiddleText("请于48小时内发货\n");
            pUtil.printLine();
            pUtil.printLine();
            pUtil.printLine();
            pUtil.printLine();
